...
# Entity Management
execute as @e[type=!player,tag=monster,tag=!dungeon_boss,predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/entire_dungeon] run function dark_dungeons:dungeons/dawnshore_dungeon/entity_management/entity_management

# Floor Activation
execute as @n[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/core_room,type=item_display,tag=dawnshore_dungeon_core,tag=!active_floor_1] if entity @p[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/floors/floor_1_activate] run function dark_dungeons:dungeons/dawnshore_dungeon/resetting/reset_floor_1

execute as @n[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/core_room,type=item_display,tag=dawnshore_dungeon_core,tag=!active_floor_2] if entity @p[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/floors/floor_2_activate] run function dark_dungeons:dungeons/dawnshore_dungeon/resetting/reset_floor_2

execute as @n[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/core_room,type=item_display,tag=dawnshore_dungeon_core,tag=!active_floor_3] if entity @p[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/floors/floor_3_activate] run function dark_dungeons:dungeons/dawnshore_dungeon/resetting/reset_floor_3
