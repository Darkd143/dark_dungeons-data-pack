...
execute as @n[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/boss_room,tag=dungeon_boss,tag=!boss_battle_pending,tag=boss_battle_in_progress,tag=underlings_summoned] unless entity @e[type=zombie,tag=!dungeon_boss,predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/boss_room] run function dark_dungeons:dungeons/dawnshore_dungeon/boss_room/underlings_defeated
...
# Update Boss Bar
execute as @n[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/boss_room,tag=dungeon_boss,tag=!boss_battle_pending,tag=boss_battle_in_progress] run function dark_dungeons:dungeons/dawnshore_dungeon/boss_room/update_boss_bar
