...
execute as @e[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/entire_dungeon,tag=monster,tag=!dungeon_boss] run function dark_dungeons:entities/management/tp_to_world_kill_zone
