...
execute unless entity @a[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/floors/floor_1/bonus_room,gamemode=adventure] run function dark_dungeons:dungeons/dawnshore_dungeon/resetting/floor_1/bonus_room
execute unless entity @a[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/floors/floor_1/middle_left_room,gamemode=adventure] run function dark_dungeons:dungeons/dawnshore_dungeon/resetting/floor_1/middle_left_room
execute unless entity @a[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/floors/floor_1/middle_room,gamemode=adventure] run function dark_dungeons:dungeons/dawnshore_dungeon/resetting/floor_1/middle_room
execute unless entity @a[predicate=dark_dungeons:positioning/dungeon/dawnshore_dungeon/floors/floor_1/middle_right_room,gamemode=adventure] run function dark_dungeons:dungeons/dawnshore_dungeon/resetting/floor_1/middle_right_room
