# Berry Bushes
execute positioned -181 92 166 run function dark_dungeons:locations/dawnshore_area/goldmere_meadow/foraging/berry_bush/place
execute positioned -165 85 245 run function dark_dungeons:locations/dawnshore_area/goldmere_meadow/foraging/berry_bush/place
execute positioned -131 95 179 run function dark_dungeons:locations/dawnshore_area/goldmere_meadow/foraging/berry_bush/place
execute positioned -133 91 222 run function dark_dungeons:locations/dawnshore_area/goldmere_meadow/foraging/berry_bush/place
execute positioned -102 85 251 run function dark_dungeons:locations/dawnshore_area/goldmere_meadow/foraging/berry_bush/place
execute positioned -75 89 246 run function dark_dungeons:locations/dawnshore_area/goldmere_meadow/foraging/berry_bush/place
execute positioned -103 93 223 run function dark_dungeons:locations/dawnshore_area/goldmere_meadow/foraging/berry_bush/place
execute positioned -88 97 182 run function dark_dungeons:locations/dawnshore_area/goldmere_meadow/foraging/berry_bush/place
execute positioned -205 87 256 run function dark_dungeons:locations/dawnshore_area/goldmere_meadow/foraging/berry_bush/place
execute positioned -217 80 206 run function dark_dungeons:locations/dawnshore_area/goldmere_meadow/foraging/berry_bush/place
...
execute positioned -118 80 268 run function dark_dungeons:locations/dawnshore_area/goldmere_meadow/foraging/berry_bush/place
