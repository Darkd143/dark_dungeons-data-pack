...
execute if block ~ ~ ~ minecraft:sweet_berry_bush[age=2] run loot spawn ~ ~ ~ loot dark_dungeons:foraging/goldmere_meadow/berries/value_1
...
execute if block ~ ~ ~ minecraft:sweet_berry_bush[age=3] run loot spawn ~ ~ ~ loot dark_dungeons:foraging/goldmere_meadow/berries/value_2
