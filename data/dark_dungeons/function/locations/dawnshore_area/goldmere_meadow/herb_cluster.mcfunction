...
execute if block ~ ~ ~ minecraft:wheat[age=3] run loot give @s loot dark_dungeons:foraging/goldmere_meadow/herbs/value_1
...
execute if block ~ ~ ~ minecraft:wheat[age=4] run loot give @s loot dark_dungeons:foraging/goldmere_meadow/herbs/value_2
...
execute if block ~ ~ ~ minecraft:wheat[age=5] run loot give @s loot dark_dungeons:foraging/goldmere_meadow/herbs/value_2
