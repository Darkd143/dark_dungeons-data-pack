# Butcher
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/butcher_zone,tag=dawnshore_butcher] run summon mannequin -110 72 66 {Invulnerable:1b,Silent:1b,Rotation:[270,0],Tags:["dawnshore_butcher"]}
