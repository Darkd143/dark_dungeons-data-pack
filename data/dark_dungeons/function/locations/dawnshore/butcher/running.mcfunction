...
# Back Room Door
execute as @e[predicate=dark_dungeons:positioning/locations/dawnshore/butcher_zone,type=minecraft:interaction,tag=dawnshore_butcher_back_room_door] store success entity @s interaction.player[] int 0 on target run function dark_dungeons:locations/dawnshore/butcher/doors/back_room/interact

# Housing Door
execute as @e[predicate=dark_dungeons:positioning/locations/dawnshore/butcher_zone,type=minecraft:interaction,tag=dawnshore_butcher_housing_door] store success entity @s interaction.player[] int 0 on target run function dark_dungeons:locations/dawnshore/butcher/doors/housing_door/interact
