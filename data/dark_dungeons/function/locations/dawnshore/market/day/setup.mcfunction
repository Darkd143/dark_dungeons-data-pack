# Fish Trader
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/market_zone,tag=dawnshore_market_fish_trader] run summon mannequin -96 72 72 {Invulnerable:1b,immovable:1b,Silent:1b,Rotation:[160,0],Tags:["dawnshore_market_fish_trader"]}
...
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/market_zone,tag=dawnshore_market_treasure_trader] run summon mannequin -91 72 72 {Invulnerable:1b,immovable:1b,Silent:1b,Rotation:[180,0],Tags:["dawnshore_market_treasure_trader"]}
...
# Berry Trader
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/market_zone,tag=dawnshore_market_berry_merchant] run summon mannequin -89 72 66 {Invulnerable:1b,immovable:1b,Silent:1b,Rotation:[90,0],Tags:["dawnshore_market_berry_merchant"]}
...
# Apothecary
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/market_zone,tag=dawnshore_market_apothecary] run summon mannequin -91 72 63 {Invulnerable:1b,immovable:1b,Silent:1b,Rotation:[10,0],Tags:["dawnshore_market_apothecary"]}
...
# Trader (misc items)
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/market_zone,tag=dawnshore_market_misc_trader] run summon mannequin -99 72 63 {Invulnerable:1b,immovable:1b,Silent:1b,Tags:["dawnshore_market_misc_trader"]}
...
# Mob Drop Dealer
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/market_zone,tag=dawnshore_market_mob_drop_trader] run summon mannequin -102 72 66 {Invulnerable:1b,immovable:1b,Silent:1b,Rotation:[270,0],Tags:["dawnshore_market_mob_drop_trader"]}
