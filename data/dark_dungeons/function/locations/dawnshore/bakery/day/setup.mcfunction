# Baker NPC
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/bakery_zone,tag=dawnshore_baker] run summon mannequin -97 72 88 {Invulnerable:1b,immovable:1b,Silent:1b,Rotation:[270,0],Tags:["dawnshore_baker"]}
