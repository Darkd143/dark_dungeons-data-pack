...
scoreboard players set @n[predicate=dark_dungeons:positioning/location/spawn_chunk_room,tag=dawnshore_inn_room_10] payed_inn_days 1
scoreboard players operation @n[predicate=dark_dungeons:positioning/location/spawn_chunk_room,tag=dawnshore_inn_room_10] player_id = @s player_id
