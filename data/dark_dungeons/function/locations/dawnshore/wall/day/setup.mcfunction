...
execute positioned -130 72 93 as @n[predicate=dark_dungeons:positioning/locations/dawnshore/dawnshore,tag=dawnshore_gate_guard_2] run function dark_dungeons:entities/mannequins/apply_skins/kingdom_npc/lookout_guard_1
