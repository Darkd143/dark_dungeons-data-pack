...
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/bank_zone,tag=dawnshore_bank_currency_exchanger] run summon mannequin -81 73 80 {Invulnerable:1b,immovable:1b,Silent:1b,Tags:["dawnshore_bank_currency_exchanger"]}
...
# Deposit Clerk
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/bank_zone,tag=dawnshore_bank_deposit_clerk] run summon mannequin -78 73 80 {Invulnerable:1b,immovable:1b,Silent:1b,Tags:['dawnshore_bank_deposit_clerk']}
...
# Withdraw Clerk
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/bank_zone,tag=dawnshore_bank_withdraw_clerk] run summon mannequin -75 73 80 {Invulnerable:1b,immovable:1b,Silent:1b,Tags:['dawnshore_bank_withdraw_clerk']}
...
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/bank_zone,tag=dawnshore_bank_balance_clerk] run summon mannequin -81 78 77 {Invulnerable:1b,immovable:1b,Silent:1b,Tags:['dawnshore_bank_balance_clerk']}
...
# Account Open Clerk
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/bank_zone,tag=dawnshore_bank_open_account_clerk] run summon mannequin -78 78 77 {Invulnerable:1b,immovable:1b,Silent:1b,Tags:['dawnshore_bank_open_account_clerk']}
...
# Account Close Clerk
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/bank_zone,tag=dawnshore_bank_close_account_clerk] run summon mannequin -75 78 77 {Invulnerable:1b,immovable:1b,Silent:1b,Tags:['dawnshore_bank_close_account_clerk']}
...
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/bank_zone,tag=dawnshore_loan_acquisition_clerk] run summon mannequin -82 78 84 {Invulnerable:1b,immovable:1b,Silent:1b,Rotation:[270,0],Tags:['dawnshore_loan_acquisition_clerk']}
...
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/bank_zone,tag=dawnshore_loan_repayment_clerk] run summon mannequin -82 78 82 {Invulnerable:1b,immovable:1b,Silent:1b,Rotation:[270,0],Tags:['dawnshore_loan_repayment_clerk']}
...
# Bank Manager
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/bank_zone,tag=dawnshore_bank_manager] run summon mannequin -86 78 89 {Invulnerable:1b,immovable:1b,Silent:1b,Rotation:[270,0],Tags:['dawnshore_bank_manager']}
