...
# Deposit Clerk
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_deposit_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=0..}] unless entity @s[predicate=dark_dungeons:inventory/holding_item/currency/copper_coin] unless entity @s[predicate=dark_dungeons:inventory/holding_item/currency/silver_coin] unless entity @s[predicate=dark_dungeons:inventory/holding_item/currency/gold_coin] unless entity @s[predicate=dark_dungeons:inventory/holding_item/currency/platinum_coin] run tellraw @s {"text":"Deposit Clerk: Hand me money and I'll deposit it into your account."}
...
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_deposit_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=0..},predicate=dark_dungeons:inventory/holding_item/currency/copper_coin] run tag @s add dawnshore_bank_deposit_copper
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_deposit_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=0..},predicate=dark_dungeons:inventory/holding_item/currency/silver_coin] run tag @s add dawnshore_bank_deposit_silver
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_deposit_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=0..},predicate=dark_dungeons:inventory/holding_item/currency/gold_coin] run tag @s add dawnshore_bank_deposit_gold
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_deposit_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=0..},predicate=dark_dungeons:inventory/holding_item/currency/platinum_coin] run tag @s add dawnshore_bank_deposit_platinum
...
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_withdraw_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=1..}] unless entity @s[predicate=dark_dungeons:inventory/holding_item/currency/copper_coin_withdraw_voucher] unless entity @s[predicate=dark_dungeons:inventory/holding_item/currency/silver_coin_withdraw_voucher] unless entity @s[predicate=dark_dungeons:inventory/holding_item/currency/gold_coin_withdraw_voucher] unless entity @s[predicate=dark_dungeons:inventory/holding_item/currency/platinum_coin_withdraw_voucher] run tag @s add dawnshore_bank_withdraw_no_voucher
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_withdraw_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=1..},predicate=dark_dungeons:inventory/holding_item/currency/copper_coin_withdraw_voucher] run tag @s add dawnshore_bank_withdraw_copper
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_withdraw_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=10..},predicate=dark_dungeons:inventory/holding_item/currency/silver_coin_withdraw_voucher] run tag @s add dawnshore_bank_withdraw_silver
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_withdraw_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=100..},predicate=dark_dungeons:inventory/holding_item/currency/gold_coin_withdraw_voucher] run tag @s add dawnshore_bank_withdraw_gold
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_withdraw_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=1000..},predicate=dark_dungeons:inventory/holding_item/currency/platinum_coin_withdraw_voucher] run tag @s add dawnshore_bank_withdraw_platinum
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_withdraw_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=1..9},predicate=dark_dungeons:inventory/holding_item/currency/silver_coin_withdraw_voucher] run tellraw @s ["Withdraw Clerk: Your current account balance is ",{score:{name:"@s",objective:"bank_money_1"}}," Eni. You don't have enough funds to withdraw a ","\u00A76🪙 Silver Coin 🪙",", ",{selector:"@s"},"."]
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_withdraw_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=1..99},predicate=dark_dungeons:inventory/holding_item/currency/gold_coin_withdraw_voucher] run tellraw @s ["Withdraw Clerk: Your current account balance is ",{score:{name:"@s",objective:"bank_money_1"}}," Eni. You don't have enough funds to withdraw a ","\u00A76🪙 Gold Coin 🪙",", ",{selector:"@s"},"."]
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_withdraw_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={bank_money_1=1..999},predicate=dark_dungeons:inventory/holding_item/currency/platinum_coin_withdraw_voucher] run tellraw @s ["Withdraw Clerk: Your current account balance is ",{score:{name:"@s",objective:"bank_money_1"}}," Eni. You don't have enough funds to withdraw a ","\u00A76🪙 Platinum Coin 🪙",", ",{selector:"@s"},"."]
...
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_open_account_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[tag=registered_player,predicate=!dark_dungeons:inventory/holding_item/currency/silver_coin] unless entity @s[scores={bank_money_1=0..}] run tellraw @s ["Open Account Clerk: There is an account opening fee of 10 Eni. Please give me a ","\u00A76🪙 Silver Coin 🪙"," and I will get your account set up, ",{selector:"@s"},"."]
execute as @e[type=minecraft:interaction,tag=dawnshore_bank_open_account_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[tag=registered_player,predicate=dark_dungeons:inventory/holding_item/currency/silver_coin] unless entity @s[scores={bank_money_1=0..}] run tag @s add dawnshore_bank_open_account
