execute unless entity @s[scores={reputation=250..,bank_money_1=5..}] run return run tellraw @s {"text":"Bank Manager: I'm sorry sir, but your credit score isn't high enough to take out a loan yet."}
...
tag @s add dawnshore_bank_cleared_for_10_eni_loan
