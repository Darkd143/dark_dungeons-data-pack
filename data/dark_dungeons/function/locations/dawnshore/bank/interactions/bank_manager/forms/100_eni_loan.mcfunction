execute unless entity @s[scores={reputation=1000..,bank_money_1=50..}] run return run tellraw @s {"text":"Bank Manager: I'm sorry sir, but your credit score isn't high enough to take out a loan yet."}
...
tag @s add dawnshore_bank_cleared_for_100_eni_loan
