...
# Armor Stands
execute unless entity @e[tag=dawnshore_scarecrow,x=-150,y=72,z=80,dx=0,dy=0,dz=0] run summon minecraft:armor_stand -150 72 80 {Invulnerable:1b,NoBasePlate:1b,equipment:{head:{id:carved_pumpkin},chest:{id:leather_chestplate,components:{dyed_color:6192150}}},Tags:['dawnshore_scarecrow'],DisabledSlots:4144959}
execute unless entity @e[tag=dawnshore_scarecrow,x=-156,y=72,z=77,dx=0,dy=0,dz=0] run summon minecraft:armor_stand -156 72 77 {Invulnerable:1b,NoBasePlate:1b,equipment:{head:{id:carved_pumpkin},chest:{id:leather_chestplate,components:{dyed_color:6192150}}},Tags:['dawnshore_scarecrow'],Rotation:[90,0],DisabledSlots:4144959}
execute unless entity @e[tag=dawnshore_scarecrow,x=-158,y=72,z=71,dx=0,dy=0,dz=0] run summon minecraft:armor_stand -158 72 71 {Invulnerable:1b,NoBasePlate:1b,equipment:{head:{id:carved_pumpkin},chest:{id:leather_chestplate,components:{dyed_color:6192150}}},Tags:['dawnshore_scarecrow'],Rotation:[270,0],DisabledSlots:4144959}
execute unless entity @e[tag=dawnshore_scarecrow,x=-149,y=72,z=71,dx=0,dy=0,dz=0] run summon minecraft:armor_stand -149 72 71 {Invulnerable:1b,NoBasePlate:1b,equipment:{head:{id:carved_pumpkin},chest:{id:leather_chestplate,components:{dyed_color:6192150}}},Tags:['dawnshore_scarecrow'],Rotation:[180,0],DisabledSlots:4144959}
# Hats
