...
execute if entity @n[type=block_display,predicate=dark_dungeons:positioning/locations/dawnshore/dawnshore,tag=dawnshore_crop_block_display_age_7,distance=..0.5] if entity @s[scores={quest_id=7},predicate=dark_dungeons:inventory/selected_item/weapon_or_tool/tool/misc/wooden_farming_sickle] run return run function dark_dungeons:locations/dawnshore/farm/field/crop_spot/harvest_crop
...
execute unless entity @n[type=block_display,predicate=dark_dungeons:positioning/locations/dawnshore/dawnshore,tag=dawnshore_crop_block_display,distance=..0.5] if entity @s[scores={quest_id=7},predicate=dark_dungeons:inventory/selected_item/plants/crops/seeds/einkorn_wheat_seeds] run return run function dark_dungeons:locations/dawnshore/farm/field/crop_spot/plant_crop
