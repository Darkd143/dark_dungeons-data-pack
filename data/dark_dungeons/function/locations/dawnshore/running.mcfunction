...
execute if entity @a[predicate=dark_dungeons:positioning/locations/dawnshore/butcher_zone] run function dark_dungeons:locations/dawnshore/butcher/running
