...
execute if entity @n[predicate=dark_dungeons:positioning/locations/spawn_chunk_room,tag=default-time-manager,predicate=dark_dungeons:time/during_night] as @e[predicate=dark_dungeons:positioning/locations/dawnshore/dawnshore,type=interaction] run function dark_dungeons:locations/dawnshore/running/locked_doors_at_night
