# Info Receptionist
execute as @n[type=minecraft:interaction,tag=dawnshore_info_receptionist_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[predicate=dark_dungeons:positioning/locations/dawnshore/registration_hut] run tag @s add dawnshore_registration_hut_unauthorized
execute as @n[type=minecraft:interaction,tag=dawnshore_info_receptionist_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[tag=!registered_player,predicate=!dark_dungeons:positioning/locations/dawnshore/registration_hut] run tellraw @s {"text":"Info Receptionist: Welcome to Dawnshore. You have been summoned here from the great beyond. Please register with my companion here to get a free beginner's set.","color":"white"}
execute as @n[type=minecraft:interaction,tag=dawnshore_info_receptionist_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[tag=registered_player,predicate=!dark_dungeons:positioning/locations/dawnshore/registration_hut] run tellraw @s {"text":"Info Receptionist: My job is to greet those summoned from the great beyond.","color":"white"}

# Registration Receptionist
execute as @n[type=minecraft:interaction,tag=dawnshore_registration_receptionist_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[predicate=dark_dungeons:positioning/locations/dawnshore/registration_hut] run tag @s add dawnshore_registration_hut_unauthorized
execute as @n[type=minecraft:interaction,tag=dawnshore_registration_receptionist_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[tag=registered_player,predicate=!dark_dungeons:positioning/locations/dawnshore/registration_hut] run tellraw @s {"text":"Registration Receptionist: I register those who have been newly summoned to this world and give them some items to start out.","color":"white"}
execute as @n[type=minecraft:interaction,tag=dawnshore_registration_receptionist_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[tag=!registered_player,predicate=!dark_dungeons:positioning/locations/dawnshore/registration_hut] run tag @s add registering_action
