execute as @e[predicate=dark_dungeons:positioning/locations/dawnshore/jailhouse_zone,tag=dawnshore_jailhouse_guard,type=!player] run function dark_dungeons:entities/management/tp_to_world_kill_zone
