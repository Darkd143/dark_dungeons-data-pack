# Fisherman
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/dawnshore,tag=dawnshore_fisherman] run summon mannequin -65 67 54 {Rotation:[180,0],Tags:['dawnshore_fisherman'],Invulnerable:1b,Silent:1b,equipment:{mainhand:{count:1,id:fishing_rod}}}
