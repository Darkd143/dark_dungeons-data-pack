# Crew Mate
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/dawnshore,tag=dawnshore_pier_ship_1_sentry] run summon mannequin -63 67 59 {Rotation:[90,0],Tags:['dawnshore_pier_ship_1_sentry','npc'],Invulnerable:1b,immovable:1b,Silent:1b}
