...
# Town Hall
execute if predicate dark_dungeons:time/during_night if entity @s[predicate=dark_dungeons:positioning/locations/dawnshore/town_hall/inside] run return run function dark_dungeons:locations/dawnshore/town_hall/kick_out