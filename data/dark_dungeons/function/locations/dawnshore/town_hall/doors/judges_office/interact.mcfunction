execute if block -116 73 88 minecraft:pale_oak_door[open=true] run return run function dark_dungeons:locations/dawnshore/town_hall/doors/judges_office/close
