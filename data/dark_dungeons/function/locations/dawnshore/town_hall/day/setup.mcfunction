# Receptionist
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/town_hall_zone,tag=dawnshore_civil_servant_receptionist] run summon mannequin -113 73 90 {Invulnerable:1b,immovable:1b,Silent:1b,Tags:['dawnshore_civil_servant_receptionist'],Rotation:[180,0]}
...
# Paymaster
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/town_hall_zone,tag=dawnshore_civil_servant_paymaster] run summon mannequin -115 73 90 {Invulnerable:1b,immovable:1b,Silent:1b,Tags:['dawnshore_civil_servant_paymaster'],Rotation:[180,0]}
