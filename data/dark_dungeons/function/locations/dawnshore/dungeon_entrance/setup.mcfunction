...
# Dungeon Pass Clerk
execute unless entity @n[predicate=dark_dungeons:positioning/locations/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_clerk] run summon mannequin -60 74 113 {Invulnerable:1b,immovable:1b,Silent:1b,Rotation:[180,0],Tags:["dawnshore_dungeon_pass_clerk"]}
