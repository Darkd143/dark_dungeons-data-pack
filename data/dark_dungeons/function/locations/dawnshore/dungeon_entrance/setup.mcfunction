...
# Gates
execute unless entity @e[predicate=dark_dungeons:positioning/location/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_office_gate_interaction_1] run summon interaction -60 75 108 {width:1,height:1,Tags:['dawnshore_dungeon_pass_office_gate_interaction','dawnshore_dungeon_pass_office_gate_interaction_1']}

execute unless entity @e[predicate=dark_dungeons:positioning/location/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_office_gate_interaction_2] run summon interaction -61 76 108 {width:1,height:1,Tags:['dawnshore_dungeon_pass_office_gate_interaction','dawnshore_dungeon_pass_office_gate_interaction_2']}

execute unless entity @e[predicate=dark_dungeons:positioning/location/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_office_gate_interaction_3] run summon interaction -59 77 108 {width:1,height:1,Tags:['dawnshore_dungeon_pass_office_gate_interaction','dawnshore_dungeon_pass_office_gate_interaction_3']}

execute unless entity @e[predicate=dark_dungeons:positioning/location/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_office_gate_interaction_4] run summon interaction -58 77 109 {width:1,height:1,Tags:['dawnshore_dungeon_pass_office_gate_interaction','dawnshore_dungeon_pass_office_gate_interaction_4']}

execute unless entity @e[predicate=dark_dungeons:positioning/location/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_office_gate_interaction_5] run summon interaction -58 76 109 {width:1,height:1,Tags:['dawnshore_dungeon_pass_office_gate_interaction','dawnshore_dungeon_pass_office_gate_interaction_5']}

execute unless entity @e[predicate=dark_dungeons:positioning/location/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_office_gate_interaction_6] run summon interaction -58 77 111 {width:1,height:1,Tags:['dawnshore_dungeon_pass_office_gate_interaction','dawnshore_dungeon_pass_office_gate_interaction_6']}

execute unless entity @e[predicate=dark_dungeons:positioning/location/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_office_gate_interaction_7] run summon interaction -58 76 112 {width:1,height:1,Tags:['dawnshore_dungeon_pass_office_gate_interaction','dawnshore_dungeon_pass_office_gate_interaction_7']}

execute unless entity @e[predicate=dark_dungeons:positioning/location/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_office_gate_interaction_8] run summon interaction -58 76 113 {width:1,height:1,Tags:['dawnshore_dungeon_pass_office_gate_interaction','dawnshore_dungeon_pass_office_gate_interaction_8']}

execute unless entity @e[predicate=dark_dungeons:positioning/location/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_office_gate_interaction_9] run summon interaction -58 77 114 {width:1,height:1,Tags:['dawnshore_dungeon_pass_office_gate_interaction','dawnshore_dungeon_pass_office_gate_interaction_9']}

execute unless entity @e[predicate=dark_dungeons:positioning/location/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_office_gate_interaction_10] run summon interaction -58 75 110 {width:1,height:1,Tags:['dawnshore_dungeon_pass_office_gate_interaction','dawnshore_dungeon_pass_office_gate_interaction_10']}

# Workstations
execute unless entity @e[predicate=dark_dungeons:positioning/location/dawnshore/dawnshore,tag=dawnshore_dungeon_pass_office_workstation_interaction] run summon interaction -61.0 74 115.0 {width:2.1,height:2.1,Tags:['dawnshore_dungeon_pass_office_workstation_interaction']}
