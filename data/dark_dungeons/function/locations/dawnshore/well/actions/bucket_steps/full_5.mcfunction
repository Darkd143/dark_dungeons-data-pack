place template dark_dungeons:well_bucket/dawnshore_well_bucket_filled -138 70 85
setblock -137 71 86 spruce_trapdoor[waterlogged=false,half=top]
setblock -137 73 86 chain[waterlogged=false,axis=y]
