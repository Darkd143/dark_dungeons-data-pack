place template dark_dungeons:well_bucket/dawnshore_well_bucket_filled -138 68 85
setblock -137 69 86 spruce_trapdoor[waterlogged=false,half=top]
setblock -137 71 86 iron_chain[waterlogged=false,axis=y]
