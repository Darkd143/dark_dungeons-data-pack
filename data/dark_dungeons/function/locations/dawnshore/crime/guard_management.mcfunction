execute unless entity @a[distance=0..10,tag=wanted_criminal,gamemode=adventure] unless entity @a[distance=0..10,tag=dawnshore_criminal,gamemode=adventure] run return run function dark_dungeons:creatures/management/tp_to_world_kill_zone
