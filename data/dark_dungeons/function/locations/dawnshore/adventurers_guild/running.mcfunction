execute as @n[type=minecraft:interaction,tag=dawnshore_adventurer_guild_receptionist_1_interaction] store success entity @s interaction.player[] int 0 on target run tag @s add dawnshore_adventurer_guild_receptionist_1_action
execute as @n[type=minecraft:interaction,tag=dawnshore_adventurer_guild_receptionist_2_interaction] store success entity @s interaction.player[] int 0 on target run tag @s add dawnshore_adventurer_guild_receptionist_2_action
execute as @n[type=minecraft:interaction,tag=dawnshore_adventurer_guild_receptionist_3_interaction] store success entity @s interaction.player[] int 0 on target run tag @s add dawnshore_adventurer_guild_receptionist_3_action
...
execute as @n[type=minecraft:interaction,tag=dawnshore_adventurer_guild_quest_sign_1_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={adventurer_rank=0..}] run tag @s add dawnshore_adventurer_guild_quest_sign_1_action
execute as @n[type=minecraft:interaction,tag=dawnshore_adventurer_guild_quest_sign_2_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={adventurer_rank=0..}] run tag @s add dawnshore_adventurer_guild_quest_sign_2_action
execute as @n[type=minecraft:interaction,tag=dawnshore_adventurer_guild_quest_sign_3_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={adventurer_rank=0..}] run tag @s add dawnshore_adventurer_guild_quest_sign_3_action
execute as @n[type=minecraft:interaction,tag=dawnshore_adventurer_guild_quest_sign_4_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={adventurer_rank=0..}] run tag @s add dawnshore_adventurer_guild_quest_sign_4_action
execute as @n[type=minecraft:interaction,tag=dawnshore_adventurer_guild_quest_sign_5_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={adventurer_rank=0..}] run tag @s add dawnshore_adventurer_guild_quest_sign_5_action
execute as @n[type=minecraft:interaction,tag=dawnshore_adventurer_guild_quest_sign_6_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={adventurer_rank=0..}] run tag @s add dawnshore_adventurer_guild_quest_sign_6_action
execute as @n[type=minecraft:interaction,tag=dawnshore_adventurer_guild_quest_sign_7_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={adventurer_rank=0..}] run tag @s add dawnshore_adventurer_guild_quest_sign_7_action
execute as @n[type=minecraft:interaction,tag=dawnshore_adventurer_guild_quest_sign_8_interaction] store success entity @s interaction.player[] int 0 on target if entity @s[scores={adventurer_rank=0..}] run tag @s add dawnshore_adventurer_guild_quest_sign_8_action
