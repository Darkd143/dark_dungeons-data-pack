...
execute if entity @s[predicate=dark_dungeons:inventory/selected_item/keys/dawnshore_adventurer_guild_key] run return run function dark_dungeons:locations/dawnshore/adventurers_guild/doors/guild_masters_door/open
