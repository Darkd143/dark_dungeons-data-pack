...
execute as @n[predicate=dark_dungeons:positioning/locations/spawn_chunk_room,tag=default-time-manager] run function dark_dungeons:locations/dawnshore/adventurers_guild/day/raiders
