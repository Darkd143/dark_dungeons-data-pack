...
execute as @n[predicate=dark_dungeons:positioning/location/spawn_chunk_room,tag=dawnshore_adventurer_quest_5] run function dark_dungeons:quests/store/completion_data
