...
execute if score @s adventurer_rank < @n[predicate=dark_dungeons:positioning/location/spawn_chunk_room,tag=dawnshore_adventurer_quest_1] adventurer_rank run return run function dark_dungeons:locations/dawnshore/adventurers_guild/actions/messages/cant_assign_higher_rank_quest
...
# Display Message
execute as @n[predicate=dark_dungeons:positioning/location/spawn_chunk_room,tag=dawnshore_adventurer_quest_1] run function dark_dungeons:quests/store/store_quest_type_string
