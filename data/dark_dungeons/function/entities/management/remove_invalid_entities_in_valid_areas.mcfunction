...
# Ender Pearl
execute as @e[predicate=dark_dungeons:positioning/area/in_valid_area,type=minecraft:ender_pearl,predicate=!dark_dungeons:entity_state/projectiles/item_is_valid,tag=!processed] run function dark_dungeons:entities/management/used_invalid_item

# Splash Potion
execute as @e[predicate=dark_dungeons:positioning/area/in_valid_area,type=minecraft:splash_potion,predicate=!dark_dungeons:entity_state/projectiles/item_is_valid,tag=!processed] run function dark_dungeons:entities/management/used_invalid_item

# Lingering Potion
execute as @e[predicate=dark_dungeons:positioning/area/in_valid_area,type=minecraft:lingering_potion,predicate=!dark_dungeons:entity_state/projectiles/item_is_valid,tag=!processed] run function dark_dungeons:entities/management/used_invalid_item
