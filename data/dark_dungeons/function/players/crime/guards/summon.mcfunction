execute if predicate dark_dungeons:positioning/locations/dawnshore/dawnshore run function dark_dungeons:entities/summoning/enemies/dawnshore_town_guard
