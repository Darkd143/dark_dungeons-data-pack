...
execute if entity @s[predicate=dark_dungeons:positioning/locations/dawnshore/dawnshore] run function dark_dungeons:locations/dawnshore/crime/guard_management
