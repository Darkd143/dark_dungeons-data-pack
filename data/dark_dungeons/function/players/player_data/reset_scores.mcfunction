...
# RPG
scoreboard players reset @s adventurer_rank
scoreboard players reset @s adventurer_xp
...
scoreboard players reset @s payed_inn_days
scoreboard players reset @s server_days_passed
...
# Quests
scoreboard players reset @s quest_type
scoreboard players reset @s quest_id
scoreboard players reset @s quest_day_limit
...
# Plants
scoreboard players reset @s growth

# Time
scoreboard players reset @s tick_time
scoreboard players reset @s hour
scoreboard players reset @s minute
scoreboard players reset @s pm