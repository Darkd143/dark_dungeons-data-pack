...
execute if entity @s[predicate=dark_dungeons:inventory/holding_item/weapon_or_tool/tool/shield/invalid_shield] run return run item modify entity @s weapon.mainhand dark_dungeons:damage_item/10-percent
