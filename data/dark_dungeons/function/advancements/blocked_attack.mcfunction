...
execute if entity @s[predicate=dark_dungeons:inventory/selected_item/weapon_or_tool/tool/shield/invalid_shield,predicate=!dark_dungeons:inventory/selected_item/weapon_or_tool/tool/shield/durability_0] run return run item modify entity @s weapon.mainhand dark_dungeons:damage_item/10-percent
