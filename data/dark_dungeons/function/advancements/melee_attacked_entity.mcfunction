...
execute if entity @s[predicate=dark_dungeons:inventory/holding_item/weapon_or_tool/not_invalid_melee] run return 0
...
execute if entity @s[predicate=!dark_dungeons:inventory/holding_item/weapon_or_tool/any_durability_0_melee] run item modify entity @s weapon.mainhand dark_dungeons:damage_item/10-percent
