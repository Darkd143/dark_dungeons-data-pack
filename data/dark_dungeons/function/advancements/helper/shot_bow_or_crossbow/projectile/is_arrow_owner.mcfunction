...
execute unless data entity @n[tag=projectile_player_testing] Owner run return run function dark_dungeons:advancements/helper/shot_bow_or_crossbow/projectile/is_arrow_owner_failure
...
execute unless score @n[tag=projectile_player_testing] temp_storage = @n[tag=projectile_player_testing] player_id run return run function dark_dungeons:advancements/helper/shot_bow_or_crossbow/projectile/is_arrow_owner_failure
