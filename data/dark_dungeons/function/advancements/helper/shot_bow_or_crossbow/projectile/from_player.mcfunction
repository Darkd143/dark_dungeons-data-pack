...
execute if data entity @s[type=firework_rocket] Owner run return 1
...
execute if data entity @s[predicate=dark_dungeons:entity_state/projectiles/cannot_be_picked_up_but_from_player,predicate=dark_dungeons:entity_state/projectiles/weapon/enchantments/infinity] Owner run return 1
return 0
