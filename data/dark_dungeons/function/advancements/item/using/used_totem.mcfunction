advancement revoke @s only dark_dungeons:item/using/used_totem

# Player not in valid area
execute if entity @s[predicate=!dark_dungeons:positioning/area/in_valid_area,advancements={dark_dungeons:item/using/used_valid_totem=true}] run return run function dark_dungeons:advancements/item/using/used_valid_totem

execute if entity @s[predicate=!dark_dungeons:positioning/area/in_valid_area] run return 0

# If Entity Used a valid totem
execute if entity @s[advancements={dark_dungeons:item/using/used_valid_totem=true}] run return run function dark_dungeons:advancements/item/using/used_valid_totem
