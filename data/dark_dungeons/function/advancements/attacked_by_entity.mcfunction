...
execute unless entity @s[predicate=dark_dungeons:inventory/wearing_item/not_valid/all] run tellraw @s {"text":"[Looks like some of your armor doesn't work well around here.]",color:"gray"}

execute if entity @s[predicate=dark_dungeons:inventory/wearing_item/not_valid/all] run tellraw @s {"text":"[Looks like your armor doesn't work well around here.]",color:"gray"}
