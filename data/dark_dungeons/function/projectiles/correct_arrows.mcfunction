execute if entity @s[predicate=dark_dungeons:entity_state/projectiles/arrows/projectile_strength_1] run data modify entity @s damage set value 0.1d
execute if entity @s[predicate=dark_dungeons:entity_state/projectiles/arrows/projectile_strength_2] run data modify entity @s damage set value 0.5d
execute if entity @s[predicate=dark_dungeons:entity_state/projectiles/arrows/projectile_strength_3] run data modify entity @s damage set value 1.0d
execute if entity @s[predicate=dark_dungeons:entity_state/projectiles/arrows/projectile_strength_4] run data modify entity @s damage set value 1.5d
execute if entity @s[predicate=dark_dungeons:entity_state/projectiles/arrows/projectile_strength_6] run data modify entity @s damage set value 2.5d
