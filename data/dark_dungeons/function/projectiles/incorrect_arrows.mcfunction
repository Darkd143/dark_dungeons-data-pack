...
execute as @s at @s run tellraw @a[predicate=!dark_dungeons:inventory/holding_item/components/custom_data/valid_item,distance=0.1..5] {"text": "This weapon doesn't seem to shoot well around here.", "color": "dark_red"}