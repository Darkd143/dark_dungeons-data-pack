...
execute as @s at @s run tellraw @a[predicate=dark_dungeons:inventory/holding_item/weapons/ranged/valid_bow,distance=0.1..5] {"text": "This ammo doesn't seem to shoot well from this bow.", "color": "dark_red"}
execute as @s at @s run tellraw @a[predicate=dark_dungeons:inventory/holding_item/weapons/ranged/valid_crossbow,distance=0.1..5] {"text": "This ammo doesn't seem to shoot well from this crossbow.", "color": "dark_red"}
execute as @s at @s run tellraw @a[predicate=!dark_dungeons:inventory/holding_item/custom_data/valid_item,distance=0.1..5] {"text": "This weapon doesn't seem to shoot well around here.", "color": "dark_red"}